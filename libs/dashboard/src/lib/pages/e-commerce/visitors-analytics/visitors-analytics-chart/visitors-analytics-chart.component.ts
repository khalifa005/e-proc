...
import { OutlineData } from '@e-proc/core';
import { LayoutService } from '@e-proc/nebular';
import echarts from 'echarts/types/dist/echarts';


@Component({
  selector: 'e-proc-visitors-analytics-chart',
...
export class ECommerceVisitorsAnalyticsChartComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.theme.getJsTheme()
      ...
      .subscribe(config => {
        const eTheme: any = config.variables;
